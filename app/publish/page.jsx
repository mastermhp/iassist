      ...
      <div className="relative z-10">
        <header className="border-b border-border/50 glass-effect">
          <div className="container mx-auto px-6 py-4">
            <h1 className="text-3xl font-bold text-glow">Social Media Publisher</h1>
            <p className="text-muted-foreground">Post your content across multiple platforms instantly</p>
          </div>
        </header>
