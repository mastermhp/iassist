...
export async function POST(request) {
  try {
    ...
    if (HF_API_KEY) {
      try {
        console.log(
          "[v0] Attempting to generate image with Hugging Face API using stable-diffusion-3-medium"
        );
        ...
        if (response.ok) {
          ...
          // Return proper URL that Facebook can access
      ...
      console.log(
        "[v0] HUGGING_FACE_API_KEY not found in environment variables"
      );
    }
