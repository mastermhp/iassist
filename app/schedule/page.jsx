      ...
      <div className="relative z-10">
        <header className="border-b border-border/50 glass-effect">
          <div className="container mx-auto px-6 py-4">
            <h1 className="text-3xl font-bold text-glow">Post Scheduler</h1>
            <p className="text-muted-foreground">Automate your social media posting with AI-powered scheduling</p>
          </div>
        </header>
