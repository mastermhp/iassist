      ...
      <div className="relative z-10">
        <header className="border-b border-border/50 glass-effect">
          <div className="container mx-auto px-6 py-4">
            <h1 className="text-3xl font-bold text-glow">AI Content Generator</h1>
            <p className="text-muted-foreground">Create engaging social media content with advanced AI</p>
          </div>
        </header>
